...
class MarketCapApiEndpoint {
    ...
    companion object {
        ...
        const val CONVERSATION = "https://pro-api.coinmarketcap.com/v2/tools/price-conversion"
        const val LISTING = "https://pro-api.coinmarketcap.com/v1/cryptocurrency/listings/latest"
        const val DATA = "https://pro-api.coinmarketcap.com/v2/cryptocurrency/info"
    }
